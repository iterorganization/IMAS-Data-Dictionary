...
### Legacy Documentation (dd_doc)
You can generate and install legacy dd_doc documentation with the following steps:

```bash
IMAS_BUILD_DOCS=1 pip install ".[docs]"
```

After this step you can open the documentation pages via the `dd_doc` command.
